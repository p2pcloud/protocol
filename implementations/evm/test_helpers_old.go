...
// 	if err := BuildToken(instances); err != nil {
// 		return nil, err
// 	}

// 	if err := BuildBroker(instances); err != nil {
// 		return nil, err
// 	}

// 	if err := SetFeeAndStablecoin(instances); err != nil {
// 		return nil, err
// 	}

// 	if err := BuildUsers(instances); err != nil {
// 		return nil, err
// 	}

// 	if err := g.InitialUserTokens(instances); err != nil {
// 		return nil, err
// 	}

// 	if err := g.InitialUserAllowances(instances); err != nil {
// 		return nil, err
// 	}
...
// 	if err = communityContract.RegenerateSession(); err != nil {
// 		return err
// 	}

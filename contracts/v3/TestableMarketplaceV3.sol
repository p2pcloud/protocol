...
contract TestableMarketplaceV3 is MarketplaceV3 {
    ...
    function test__increaseSpendingPerMinute(address user, uint256 amt) public onlyOwner {
        _totalSpendingPerMinute[user] += amt;
    }

    function test__increaseBalance(address user, uint256 amt) public onlyOwner {
        _coinBalance[user] += amt;
    }
...
contract TestableMarketplaceV3Upgraded is TestableMarketplaceV3 {
    string public helloWorld; //just any new varable to test the upgrade
}
